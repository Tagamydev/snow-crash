Decompile the program using ghidra
...
just remove the check and compile again 

```bash
(venv) andres@andres-System-Product-Name:~/snow-crash/flag13$ gcc main.c 
(venv) andres@andres-System-Product-Name:~/snow-crash/flag13$ ./a.out 
your token is g
```